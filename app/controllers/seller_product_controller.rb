class SellerProductController < ApplicationController
    ...
    def create
        ...
        if @seller_product.save
          redirect_to seller_products_path, notice: "Seller product was successfully created."
        else
          render :new
        end
    end
    ...
    def update
        ...
        if @seller_product.update(seller_product_params)
            redirect_to seller_products_path, notice: "Seller product was successfully updated."
        else
            render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to seller_products_path, notice: "Seller product was successfully deleted."
    end
